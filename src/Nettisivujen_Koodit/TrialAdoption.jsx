...
function TrialAdoption() {
  return (
    <div className='bg-color-grey'>
      <div className='bg-color-yellow p-8 text-center'>
        ...
        <div className='bg-color-grey'>
          <Row className="justify-content-center"  style={{ margintop:"4rem" ,marginBottom: "4rem"}}>
            <Col md={8} lg={6} className="text-center">
              <h1>What Is a Trial Adoption?</h1>
              ...
              <h1>How Long Does the Trial Last?</h1>
              ...
              <h1>What's Required from the Adopter?</h1>
