        ...
        <div className='bg-color-grey'>
            ...
            <div className='bg-color-grey p-5'>
              <Row className="justify-content-center"  style={{ margintop:"4rem" ,marginBottom: "4rem"}}>
                <Col md={8} lg={6} className="text-center">
                    <h1>Step-by-Step Adoption Process</h1>
                    ...
                    <div className='adoption-process'>
                        <ul className='list-unstyled'>
                            <li>
                                <h2>1. Explore Available Dogs</h2>
                            ...
                            <li>
                                <h2>2. Visit & Submit an Adoption Application</h2>
                                <p className="white-background p-3">
                            ...
                            <li>
                                <h2>3. Application Review & Phone Interview</h2>
                                <p className="white-background p-3">
                            ...
                            <li>
                            <h2>4. Follow-Up Meet & Greet (If Needed)</h2>
                                <p className="white-background p-3">
                            ...
                            <li>
                                <h2>6. Home Check (Virtual or In-Person)</h2>
                                <p className="white-background p-3">
                            ...
                            <li>
                                <h2>7. Adoption Contract & Payment</h2>
                                <p className="white-background p-3">
          ...
          <div className='bg-color-yellow p-5' style={{padding: "2rem", textAlign: "center" }}>
            ...
            <h1>Contact Info</h1>
                ...
                <p>
                    Check out our <a className='link-bold' href="/adoption/faq">FAQ</a> section or <a className='link-bold' href="/contact-details">contact us</a> for more information. 
                </p>
            </div>
